...
export default function AboutFounder() {
  ...
  return (
    <section className="px-6 sm:px-12 md:px-[60px] py-10 sm:py-16 md:py-[80px] w-full flex flex-col md:flex-row items-center md:items-start justify-between gap-8 md:gap-[20px]">
      {/* Left Image with scroll-zoom */}
      <motion.div
        ref={ref}
        style={{ scale }}
        className="flex-1 relative md:left-[10px] flex justify-center md:justify-start"
      >
        <div className="w-full max-w-[400px] sm:max-w-[600px] md:max-w-[720px] h-auto md:h-[720px] rounded-[20px] overflow-hidden">
          <Image
      ...
      {/* Right Text */}
      <div className="flex-1 max-w-full md:max-w-[750px]">
        <h2
          className={`${tenor.className} text-2xl sm:text-3xl md:text-[32px] text-[#676A5E] uppercase tracking-[0.2em] mb-6 text-center md:text-left`}
        >
          A Note From the Founder
        </h2>

        <p className={`${archivo.className} text-sm sm:text-base text-[#676A5E] leading-relaxed mb-2`}>
        ...
        <p className={`${archivo.className} text-sm sm:text-base text-[#676A5E] leading-relaxed mb-6`}>
        ...
        <p className={`${archivo.className} text-sm sm:text-base text-[#676A5E] leading-relaxed mb-10`}>
          Thank you for being here I’m so excited for you to experience what we’re building.
        </p>

        {/* Centered signature */}
        <div className="flex justify-center">
          <p className={`${pinyon.className} text-xl sm:text-2xl text-[#000000]`}>
            Irsa Khan
          </p>
        </div>
      </div>
